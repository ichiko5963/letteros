// Manual Launch Content Creation Page
// Reference: Original products/new/page.tsx - Manual form input
...
export default function ManualProductPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>ローンチコンテンツ情報</CardTitle>
                    <CardDescription>
                        ローンチコンテンツとは「口調・思想・読者・目的が一貫した発信主体」の単位です。
                        一人が複数のローンチコンテンツを持つことも前提としています。
                    </CardDescription>
                </CardHeader>
                <CardContent>
